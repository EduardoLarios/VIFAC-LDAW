...
urlpatterns = [
    ...
    url(r'^detalle_donador/(?P<pk>\d+)/$', views.DonorDetail.as_view(), name="donor_detail"),
    ...
    url(r'^detalle_donacion/(?P<pk>\d+)/$', views.DonationDetail.as_view(), name="donation_detail"),
    ...
    url(r'^detalle_categoria/(?P<pk>\d+)/$', views.CategoryDetail.as_view(), name="category_detail"),
]
