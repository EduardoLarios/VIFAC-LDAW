...
urlpatterns = [
    ...
    url(r'^borrar_donador/(?P<pk>\d+)$', DonorDelete.as_view(), name='donor_delete'),
    ...
    url(r'^borrar_donacion/(?P<pk>\d+)$', DonationDelete.as_view(), name='donation_delete'),
    ...
    url(r'^borrar_categoria/(?P<pk>\d+)$', CategoryDelete.as_view(), name = 'category_delete'),
