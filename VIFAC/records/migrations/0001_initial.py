# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-13 17:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_civil', models.CharField(choices=[('Soltero', 'Soltero'), ('Casado', 'Casado'), ('Divorciado', 'Divorciado'), ('Viudo', 'Viudo'), ('Unión Libre', 'Unión Libre')], help_text='Estado Civil', max_length=128, verbose_name='Estado Civil')),
                ...
                ('tipo_poblacion', models.CharField(blank=True, choices=[('Rural', 'Rural'), ('Urbana', 'Urbana'), ('Indigena', 'Indigena')], default='', help_text='Tipo de Población', max_length=128, verbose_name='Tipo de Población')),
                ('migrante', models.CharField(choices=[('No', 'No'), ('Si', 'Si')], help_text='Migrante', max_length=12, verbose_name='Migrante')),
                ...
                ('vive_padre', models.CharField(blank=True, choices=[('No sabe', 'No sabe'), ('No', 'No'), ('Si', 'Si')], default='', help_text='¿Tu padre vive?', max_length=256, verbose_name='Vive padre')),
                ...
                ('padre_fecha_nacimiento', models.DateField(blank=True, default=None)),
                ('padre_estado_civil', models.CharField(blank=True, choices=[('Soltero', 'Soltero'), ('Casado', 'Casado'), ('Divorciado', 'Divorciado'), ('Viudo', 'Viudo'), ('Unión Libre', 'Unión Libre')], help_text='Estado Civil', max_length=128, verbose_name='Estado Civil')),
                ...
                ('vive_madre', models.CharField(blank=True, choices=[('No sabe', 'No sabe'), ('No', 'No'), ('Si', 'Si')], default='', help_text='¿Tu madre vive?', max_length=256, verbose_name='Vive madre')),
                ...
                ('madre_estado_civil', models.CharField(blank=True, choices=[('Soltero', 'Soltero'), ('Casado', 'Casado'), ('Divorciado', 'Divorciado'), ('Viudo', 'Viudo'), ('Unión Libre', 'Unión Libre')], help_text='Estado Civil', max_length=128, verbose_name='Estado Civil')),
                ...
                ('trabajado_antes', models.CharField(blank=True, choices=[('No', 'No'), ('Si', 'Si')], default='', max_length=12)),
