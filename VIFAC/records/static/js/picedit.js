...
;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		_hideAllNav: function (message) {
			if(message && message == 1) {
				this.set_messagebox("Selecciona una imagen o toma una de la cámara para editarla!");
			}
