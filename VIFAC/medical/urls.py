...
urlpatterns = [
    ...
    url(r'^editar_laboratorio/(?P<pk>[0-9]+)/$', views.LaboratorioEdit.as_view(), name='edit_lab'),
    ...
    url(r'^editar_ultrasonido/(?P<pk>[0-9]+)/$', views.UltrasonidoEdit.as_view(), name='edit_us'),
    ...
    url(r'^editar_problema/(?P<pk>[0-9]+)/$', views.ProblemasEdit.as_view(), name = 'edit_problem'),
